	...
	bool windowed)
{
	...
	hwnd = CreateWindowEx(
		NULL,
		WndClassName,
		L"Lesson 31 - Simple Third Person Camera",
		WS_OVERLAPPEDWINDOW,
...
bool InitScene()
{
	...
	if (!LoadObjModel(L"landmine.obj", &meshVertBuff, &meshIndexBuff, meshSubsetIndexStart, meshSubsetTexture, material, meshSubsets, true, true))
		return false;
	...
	light.pos = XMFLOAT3(0.0f, 0.5f, 1.0f);
	light.dir = XMFLOAT3(0.0f, 0.75f, 0.0f);
	light.range = 0.4f;
	light.cone = 0.4f;
	...
	//Camera information
	camPosition = XMVectorSet(0.0f, 5.0f, 4.0f, 0.0f);
	...
	hr = D3DX11CreateTextureFromFile(d3d11Device, L"Above_The_Sea.dds", &loadSMInfo, 0, (ID3D11Resource**)&SMTexture, 0);
...
void UpdateScene(double time)
{
	...
	Translation = XMMatrixTranslation(2.0f, 0.0f, 4.0f);
